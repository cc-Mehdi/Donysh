...
صفحه «دستیار هوشمند» ماه‌هایی را که دارای خرج، بودجه، واریز پس‌انداز یا قسط زمان‌بندی‌شده هستند نمایش می‌دهد. کاربر یک ماه را انتخاب می‌کند و فایل JSON همان دوره را برای فضای مالی فعال می‌گیرد؛ فایل علاوه بر snapshot ماه انتخابی، شامل راهنمای فارسی تحلیل مالی، فرهنگ داده‌ها و قرارداد `donysh.changes` است. کاربر فایل را به سرویس AI انتخابی خود می‌دهد و JSON پیشنهادی را دوباره در Donysh وارد می‌کند.
